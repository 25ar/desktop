(function(){
  ...
  this.Options = new function(){
    ...
    this.sdOverwriteServerData = function(){
      ...
      fvdSynchronizer.Dialogs.confirm( _("dlg_speeddial_confirm_overwrite_server_data_title"), _("dlg_speeddial_confirm_overwrite_server_data_text"), function( result ){
        ...
        if( result ){
          ...
          fvdSynchronizer.Dialogs.syncProgress( "sdOverwriteServerData", function(){
            self.refreshInitialSync();
          } );
    ...
    this.bookmarksOverwriteServerData = function(){
        ...
        if( result ){
          ...
          fvdSynchronizer.Utils.Async.chain([
            ...
            function(){
              ...
              fvdSynchronizer.Dialogs.syncProgressSimple( "Bookmarks", "overwriteServerData", function(){
                self.refreshInitialSync();
              } );
    ...
    function refreshTabsByHash(){
      ...
      if( document.location.hash == "#sync-bookmarks" ){
        fvdSynchronizer.Controls.Tabs.addInitCallback(function(){
    ...
    chrome.extension.onMessage.addListener( function( r ){
      ...
      if( r.action && r.action == "options:refreshTabs" ){
        refreshTabsByHash();
      }
