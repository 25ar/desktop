if (window == chrome.extension.getBackgroundPage()) {
	...
	(function(){
		...
		function SyncRequest(aData, aCallback, form){
			...
			if( fvdSynchronizer.Server.Sync.releaseType() == "local" ){
				var url = "http://globalhost:8124";			
			}
			else if( fvdSynchronizer.Server.Sync.releaseType() == "testing" ){				
				var url = "http://test.everhelper.me";							
			}
			else{
