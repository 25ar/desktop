  ...
  if (window == chrome.extension.getBackgroundPage()) {
      ...
      function mapDialsLocalToServer( localDials, extra ){
        ...
        localDials.forEach( function( localDial ){
          ...
          if( localDial.thumb_source_type == "local_file" || localDial.get_screen_method == "manual" ){
      ...
      function mapDialsServerToLocal( serverDials ){
        ...
        serverDials.forEach( function( serverDial ){
          ...
          if( localDial.thumb_source_type == "screen" && serverDial.local_file_type == "manual_crop" ){
        ...
        fvdSynchronizer.Utils.Async.chain([
          ...
          function hasUpdates(callback){
              ...
              var request = {
                  ...
                  lastUpdateTimeDials: getDialsLastUpdateTime(),
                  lastUpdateTimeGroups: getGroupsLastUpdateTime()
              };
