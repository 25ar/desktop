			...
			port.onMessage.addListener(function(message){
				...
				switch (message.message) {
					...
					case "show_crop_area":
						...
						if( document.documentElement.clientWidth < initData.init.width ){
							initData.init.width = document.documentElement.clientWidth;
							initData.init.height = initData.init.width / whRatio;
						}
						
						if( document.documentElement.clientHeight < initData.init.height ){
							initData.init.height = document.documentElement.clientHeight;
							initData.init.width = initData.init.height * whRatio;
						}
						
						var x1 = Math.round((document.documentElement.clientWidth - initData.init.width)/2);
						var y1 = Math.round((window.innerHeight - initData.init.height)/2);
