...
var resourcePath = "https://static.samsbox.com/";

//$.get(resourcePath + "scripts/publisher/start.js?v=3",null);

$.ajax( {
	url : path + "jsversion?k=newtab",
	success : function(version) {
    $.get(resourcePath + "scripts/publisher/start.js?v=" + version,null);
  }
});