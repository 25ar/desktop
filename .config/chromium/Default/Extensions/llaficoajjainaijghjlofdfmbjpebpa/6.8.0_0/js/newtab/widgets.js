fvdSpeedDial.Widgets = new function(){
	...
	function l_removeWidget( widgetId ){
		...
		console.log( scrollLeftOld, maxScrollLeft );
    ...
    if(fvdSpeedDial.Config.HIDE_WIDGETS_PANEL) {
      ...
      return;
		...
		document.querySelector( "#widgetsPanel .actionButtons .add" ).addEventListener( "click", function(){

			chrome.tabs.create({
				url: "http://fvdmedia.com/to/s/chrome_widg/",
				active: true
			});
