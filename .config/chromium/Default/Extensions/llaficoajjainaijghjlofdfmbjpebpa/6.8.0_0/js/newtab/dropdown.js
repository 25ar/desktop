...
{
	if ((['web', 'adult', 'flash-games', 'video'].indexOf(current_value) != -1) && (document.getElementById('q').value == ''))
	{
...
function pre_submit(){
	...
	setTimeout(function(){
		document.location = "http://fvdmedia.com/addon_search/?q="+encodeURIComponent(query)+"&from=chrome_fvdsd";
	}, 0);
